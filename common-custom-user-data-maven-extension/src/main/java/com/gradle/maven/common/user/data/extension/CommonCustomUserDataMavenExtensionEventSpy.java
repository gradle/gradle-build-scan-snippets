...
public final class CommonCustomUserDataMavenExtensionEventSpy extends AbstractEventSpy {
    ...
    public void init(Context context) {
        try {
            ApiAccessor.registerExtension(getClass(), container, logger);
        } catch (Exception e) {
            logger.error("Common Custom User Data Maven extension could not register itself with the Gradle Enterprise Maven extension due to: " + e.getMessage(), e);
        }
    }
